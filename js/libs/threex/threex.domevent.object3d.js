...
THREE.Object3D.prototype.addEventListener = function(eventName, callback, useCapture){
	THREE.Object3D._threexDomEvent.bind(this, eventName, callback, useCapture);
	return this;
}
